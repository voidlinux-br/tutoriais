...
- configurações do kernel (sysctl)
...
# 5. Configurações do kernel (sysctl)
...
# 6. Verifique páginas enormes transparentes
...
# 9. Aplique BFQ automaticamente sem inicialização
