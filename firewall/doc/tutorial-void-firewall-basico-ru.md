...
# 🔥 БРАНДМАУЭР + ПРОКСИ, ИНТЕГРИРОВАННЫЙ В ДОМЕН SAMBA4 (VOIDBR.ORG)

## 🎯 ЦЕЛЬ этого руководства — настроить сервер **Firewall + Squid Proxy** на **Debian 13**, действующий как **основной шлюз (192.168.70.254)** и интегрированный в домен **VOIDBR.ORG** (контроллер домена: **192.168.70.253**), для аутентификации пользователей в Squid через **Active Directory. (NTLM)** и примените **политику блокировки**.
