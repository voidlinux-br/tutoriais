...
# 🔥 방화벽 + 프록시가 SAMBA4 도메인(VOIDBR.ORG)에 통합되었습니다.

## 🎯 이 튜토리얼의 목표는 **Debian 13**에서 **방화벽 + Squid 프록시** 서버를 구성하고 **주 게이트웨이(192.168.70.254)** 역할을 하며 **VOIDBR.ORG** 도메인(도메인 컨트롤러: **192.168.70.253**)에 통합하여 **Active Directory(NTLM)**을 통해 Squid에서 사용자를 인증하고 **차단을 적용하는 것입니다. 정책**.
