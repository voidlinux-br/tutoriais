...
# 🔥 FIREWALL + PROXY INTEGRATI NEL DOMINIO SAMBA4 (VOIDBR.ORG)

## 🎯 L'OBBIETTIVO di questo tutorial è configurare un server **Firewall + Squid Proxy** su **Debian 13**, che agisca come **gateway principale (192.168.70.254)** e integrato nel dominio **VOIDBR.ORG** (controller di dominio: **192.168.70.253**), per autenticare gli utenti in Squid tramite **Active Directory (NTLM)** e applicare il **blocco politiche**.
...
- Controller di dominio: SRVDC01 192.168.70.253
