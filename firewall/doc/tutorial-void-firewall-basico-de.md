...
# 🔥 FIREWALL + PROXY IN DIE SAMBA4-DOMÄNE INTEGRIERT (VOIDBR.ORG)

## 🎯 ZIEL in diesem Tutorial ist die Konfiguration eines **Firewall + Squid Proxy**-Servers unter **Debian 13**, der als **Haupt-Gateway (192.168.70.254)** fungiert und in die **VOIDBR.ORG**-Domäne (Domänencontroller: **192.168.70.253**) integriert ist, um Benutzer in Squid über **Active Directory (NTLM)** zu authentifizieren und **Blockierung anzuwenden Richtlinien**.
